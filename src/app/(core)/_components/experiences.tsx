...
export const Experiences = () => (
  <div className="flex flex-col gap-2">
    {experiences.map((experience) => (
      <div
        key={experience.key}
        className="grid grid-cols-2 items-center gap-4 rounded-2xl bg-light-400 px-5 py-3"
      >
        <div className="inline-grid grid-cols-1 md:grid-cols-2">
          ...
          <p className="text-left font-medium font-sf-pro-display-medium text-gray-400 text-sm tracking-tight md:text-right">
            {experience.role}
          </p>
        </div>
